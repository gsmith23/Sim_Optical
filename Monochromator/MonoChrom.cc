...
// ********************************************************************
//
/// \file MonoChrom/MonoChrom.cc
/// \brief Main program of the MonoChrom example
//
//
//
...
namespace {
  void PrintUsage() {
    G4cerr << " Usage: " << G4endl;
    G4cerr << " MonoChrom [-m macro ] [-u UIsession] [-t nThreads] [-r seed] "
           << G4endl;
...
#else
     UImanager->ApplyCommand("/control/execute MonoChrom.in");
#endif
     if (ui->IsGUI()){
